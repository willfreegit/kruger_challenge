package com.will.vaccination.security.configuration;

import com.will.vaccination.security.filter.CustomAutenticationFilter;
import com.will.vaccination.security.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {;
        ...
        http.authorizeRequests().antMatchers(GET, "/vaccine/getAllVaccines/**").permitAll();
        http.authorizeRequests().antMatchers(POST, "/person/addAdmin/**").permitAll();
