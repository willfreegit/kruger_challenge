...
public class PersonUnitTest {
    ...
    public void addPersonWithIncompleteInformation(){
        Person person = new Person("0101","aaaa","bbb",null,null,null,null);
    ...
    public void addPersonWithIncorrectIdentification(){
        Person person = new Person("0101","aaaa","bbb","will@hotmail.com",null,null,null);
        assertEquals(HttpStatus.BAD_REQUEST,personController.addPerson(person).getStatusCode());
    }

    @Test
    public void addPersonWithIncorrectEmail(){
        Person person = new Person("0104112347","aaaa","bbb","aaa.bbb.ccc",null,null,null);
        assertEquals(HttpStatus.BAD_REQUEST,personController.addPerson(person).getStatusCode());
    }

    @Test
    public void addPersonWithWrongNames(){
        Person person = new Person("0104112347","1234","abè","wilson@hotmal.com",null,null,null);
        assertEquals(HttpStatus.BAD_REQUEST,personController.addPerson(person).getStatusCode());
    }

    @Test
    public void addPersonWithCorrectInformation(){
        Person person = new Person("0104112347","Wilson Vinicio","Monge Llivisaca","wmonge@hotmail.com",null,null,null);
